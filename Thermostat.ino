...
//<InitGUI !Start!>
  ...
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,E_ELEM_BTN2,E_PG_MAIN,
    (gslc_tsRect){128,79,40,20},(char*)"Up",0,E_FONT_TXT5,&CbBtnCommon);
  ...
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,E_ELEM_BTN3,E_PG_MAIN,
    (gslc_tsRect){128,137,40,20},(char*)"Down",0,E_FONT_TXT5,&CbBtnCommon);
  
  // Create E_ELEM_TEXT2 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT2,E_PG_MAIN,(gslc_tsRect){241,118,48,10},
