...
enum {AC_BTN,AUTO_BTN,CUR_TEMP_TEXT,DATE_TEXT,DOWN_BTN,E_DRAW_LINE1
      ,E_ELEM_IMAGE2,E_ELEM_TEXT7,E_ELEM_TEXT8,HEAT_BTN,HOLD_BTN
      ,HOME_BUTTON_1,OFF_BTN,PRGM_BTN,SETTINGS_BTN,SET_TEMP_TEXT,UP_BTN
...
#define MAX_ELEM_PG3 0 // # Elems total on page
