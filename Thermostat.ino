...
enum {E_ELEM_BTN2,E_ELEM_BTN3,E_ELEM_TEXT1,E_ELEM_TEXT2,E_ELEM_TEXT3};
...
//<InitGUI !Start!>
  ...
  gslc_ElemCreateBtnTxt_P(&m_gui,E_ELEM_BTN3,E_PG_MAIN,120,140,80,40,
    "Down",&m_asFont[E_FONT_TXT5],
    GSLC_COL_WHITE,GSLC_COL_BLUE_DK2,GSLC_COL_BLUE_DK4,GSLC_COL_BLUE_DK2,
    GSLC_COL_CYAN,GSLC_ALIGN_MID_MID,true,true,&CbBtnCommon,NULL);
  
  // Create E_ELEM_TEXT2 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT2,E_PG_MAIN,(gslc_tsRect){260,100,48,10},
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT3,E_PG2,(gslc_tsRect){100,110,84,10},
    (char*)"Yeet the skeet",0,E_FONT_TXT5);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_BLACK);
