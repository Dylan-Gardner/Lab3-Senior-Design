...
enum {AC_BTN,AUTO_BTN,CUR_TEMP_TEXT,DATE_TEXT,DOWN_BTN,E_DRAW_LINE1
      ...
      ,E_ELEM_BTN32,E_ELEM_BTN33,E_ELEM_BTN35,E_ELEM_BTN36,E_ELEM_BTN37
      ,E_ELEM_BTN38,E_ELEM_BTN40,E_ELEM_BTN41,E_ELEM_TEXT10
      ,E_ELEM_TEXT11,E_ELEM_TEXT12,E_ELEM_TEXT13,E_ELEM_TEXT14
      ,E_ELEM_TEXT15,E_ELEM_TEXT16,E_ELEM_TEXT17,E_ELEM_TEXT7
...
//<InitGUI !Start!>
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT15,E_PG4,(gslc_tsRect){180,110,24,10},
    (char*)"Temp",0,E_FONT_TXT5);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_BLACK);
  gslc_ElemSetCol(&m_gui,pElemRef,GSLC_COL_GRAY,GSLC_COL_WHITE,GSLC_COL_BLACK);
