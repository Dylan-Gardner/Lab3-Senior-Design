...
enum {AC_BTN,AUTO_BTN,CUR_TEMP_TEXT,DATE_TEXT,DOWN_BTN,E_DRAW_LINE1
      ...
      ,E_ELEM_BTN32,E_ELEM_BTN33,E_ELEM_IMAGE2,E_ELEM_TEXT10
      ,E_ELEM_TEXT11,E_ELEM_TEXT12,E_ELEM_TEXT13,E_ELEM_TEXT14
      ,E_ELEM_TEXT7,E_ELEM_TEXT8,E_ELEM_TEXT9,HEAT_BTN,HOLD_BTN
      ,HOME_BUTTON_1,HOME_BUTTON_2,OFF_BTN,PRGM_BTN,SETTINGS_BTN
      ,SET_TEMP_TEXT,UP_BTN,WKND_1_BTN,WKND_2_BTN,WKND_3_BTN,WKND_4_BTN
      ,WK_1_BTN,WK_2_BTN,WK_3_BTN,WK_4_BTN};
...
#define MAX_ELEM_PG_MAIN 13 // # Elems total on page
...
//<InitGUI !Start!>
  ...
  // create UP_BTN button with text label
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,UP_BTN,E_PG_MAIN,
  ...
  pElemRef = gslc_ElemCreateImg(&m_gui,E_ELEM_IMAGE2,E_PG_MAIN,(gslc_tsRect){260,190,32,32},
